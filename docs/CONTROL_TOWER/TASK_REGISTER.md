...
| P9-SEC-001 | Security | SCA (pip-audit) severity gate + expiring waivers | **DONE — 2026-01-20** | SARIF emitted; gate via `tools/security/pip_audit_gate.py` | `tools/security/pip_audit_gate.py`, `docs/GOVERNANCE/waivers_sca.json` | **HIGH** blocks; **MEDIUM** needs waiver; **LOW** non-blocking. |
