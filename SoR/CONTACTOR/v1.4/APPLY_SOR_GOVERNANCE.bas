Attribute VB_Name = "APPLY_SOR_GOVERNANCE"
Option Explicit

'========================
' SoR Governance Macro
...
'DATA SHEETS (exact list for CONTACTOR)
Private Function IsDataSheet(ByVal wsName As String) As Boolean
    Dim n As String
    n = LCase(Trim(wsName))
    
    IsDataSheet = ( _
        n = "item_tesys_eocr_work" Or _
        n = "item_tesys_protect_work" Or _
        n = "item_giga_series_work" Or _
        n = "item_k_series_work" Or _
        n = "item_capacitor_duty_work" Or _
