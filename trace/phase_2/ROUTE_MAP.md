...
| Method | URI | Route Name | Middleware/Auth | Controller@Method | Module | Sub-Area | Views/JS (if known) | Notes |
|---|---|---|---|---|---|---|---|---|
| GET | / | home | auth | HomeController@index | - | - | home/index.blade.php | Home page |
| GET | /home | home | auth | HomeController@index | - | - | home/index.blade.php | Home page alias |
| GET | /api/category/{categoryId}/subcategories | api.category.subcategories | auth, throttle:search | QuotationController@getSubCategories | Quotation | V2 | - | AJAX endpoint |
| GET | /api/category/{categoryId}/items | api.category.items | auth, throttle:search | QuotationController@getItems | Quotation | V2 | - | AJAX endpoint |
| GET | /api/category/{categoryId}/products | api.category.products | auth, throttle:search | QuotationController@getProducts | Quotation | V2 | - | AJAX endpoint |
| GET | /api/item/{itemId}/products | api.item.products | auth, throttle:search | QuotationController@getProductsByItem | Quotation | V2 | - | Type-first filtering |
| GET | /api/product/{productId}/makes | api.product.makes | auth, throttle:search | QuotationController@getMakes | Quotation | V2 | - | AJAX endpoint |
| GET | /api/make/{makeId}/series | api.make.series | auth, throttle:search | QuotationController@getSeriesApi | Quotation | V2 | - | AJAX endpoint |
| GET | /api/product/{productId}/descriptions | api.product.descriptions | auth, throttle:search | QuotationController@getDescriptions | Quotation | V2 | - | AJAX endpoint |
| GET | /api/category/{categoryId}/makes | api.category.makes | auth, throttle:search | QuotationController@getMakesByCategory | Quotation | V2 | - | Bulk edit |
| GET | /api/makes | api.makes | auth, throttle:search | QuotationController@getAllMakes | Quotation | V2 | - | Fallback |
...
| GET | /client | client.index | auth | ClientController@index | Project | Clients | client/index.blade.php | Client list |
| GET | /client/create | client.create | auth | ClientController@create | Project | Clients | client/create.blade.php | Create client |
| POST | /client/create | client.store | auth | ClientController@store | Project | Clients | - | Store client |
| GET | /client/{id}/edit | client.edit | auth | ClientController@edit | Project | Clients | client/edit.blade.php | Edit client |
| PUT | /client/{id}/edit | client.update | auth | ClientController@update | Project | Clients | - | Update client |
| DELETE | /client/{id}/destroy | client.destroy | auth | ClientController@destroy | Project | Clients | - | Delete client |
| GET | /client/{id}/getState | client.getState | auth | ClientController@getState | Project | Clients | - | AJAX state lookup |
...
| GET | /contact | contact.index | auth | ContactController@index | Project | Contacts | contact/index.blade.php | Contact list |
| GET | /contact/create | contact.create | auth | ContactController@create | Project | Contacts | contact/create.blade.php | Create contact |
| POST | /contact/create | contact.store | auth | ContactController@store | Project | Contacts | - | Store contact |
| GET | /contact/{id}/edit | contact.edit | auth | ContactController@edit | Project | Contacts | contact/edit.blade.php | Edit contact |
| PUT | /contact/{id}/edit | contact.update | auth | ContactController@update | Project | Contacts | - | Update contact |
| DELETE | /contact/{id}/destroy | contact.destroy | auth | ContactController@destroy | Project | Contacts | - | Delete contact |
...
| GET | /proposal-bom | proposal-bom.index | auth | ProposalBomController@index | Proposal BOM | Structure | proposal-bom/index.blade.php | Proposal BOM list |
| GET | /proposal-bom/{id} | proposal-bom.show | auth | ProposalBomController@show | Proposal BOM | Structure | proposal-bom/show.blade.php | Show Proposal BOM |
| GET | /proposal-bom/{id}/reuse | proposal-bom.reuse | auth | ProposalBomController@reuse | Proposal BOM | Workflows | - | Reuse Proposal BOM |
| POST | /proposal-bom/{id}/promote | proposal-bom.promote | auth | ProposalBomController@promoteToMaster | Proposal BOM | Workflows | - | Promote to Master |
...
| POST | /quotation/v2/apply-proposal-bom | quotation.v2.applyProposalBom | auth, throttle:critical-write | QuotationV2Controller@applyProposalBom | Quotation | V2 | - | Apply Proposal BOM |
...
| GET | /pdfcontain | pdfcontain.index | auth | ImportController@pdfcontain | Master | PDF Formats | pdfcontain/index.blade.php | PDF container |
| PUT | /pdfcontain | pdfcontain.save | auth | ImportController@pdfcontainsave | Master | PDF Formats | - | Save PDF container |
| GET | /mySQLDownload | mySQLDownload | auth | CronController@mySQLDownload | - | - | - | MySQL download |
| GET | /clear | - | auth | Closure | - | - | - | Clear cache |
