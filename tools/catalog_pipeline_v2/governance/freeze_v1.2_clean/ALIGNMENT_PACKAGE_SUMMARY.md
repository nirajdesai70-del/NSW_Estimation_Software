...
- `governance/freeze_v1.2_clean/ALIGNMENT_PACKAGE_SUMMARY.md` (this file)
- `governance/freeze_v1.2_clean/gate_i_column_contract.py` (Gate I validator script)

**LC1E-Specific Documents:**
- `active/schneider/LC1E/04_docs/POINTERS.md` (points to governance folder)
- `active/schneider/LC1E/04_docs/QC_SUMMARY.md` (LC1E-specific)
- `active/schneider/LC1E/04_docs/STEP_5_EXECUTION_PLAN.md` (LC1E-specific)
...
- Documents are stored in shared `governance/freeze_v1.2_clean/` folder to prevent divergence
- Each series has a `POINTERS.md` file linking to universal governance docs
